...
namespace DoctrineProxies\__CG__\App\Entity\User;
...
class User extends \App\Entity\User\User implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['name' => NULL, 'email' => NULL, 'password' => NULL];
    ...
    {
        unset($this->name, $this->email, $this->password);
