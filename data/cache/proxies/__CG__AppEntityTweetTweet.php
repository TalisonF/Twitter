...
namespace DoctrineProxies\__CG__\App\Entity\Tweet;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Tweet extends \App\Entity\Tweet\Tweet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['user' => NULL, 'tweet' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'user', 'tweet', 'id', 'hash', 'created_at', 'updated_at', 'deleted_at'];
        }

        return ['__isInitialized__', 'id', 'hash', 'created_at', 'updated_at', 'deleted_at'];
    }
